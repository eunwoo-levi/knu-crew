...
export default function Navbar() {
  return (
    <nav className='fixed left-0 top-0 z-50 flex h-[70px] w-full items-center justify-between bg-white px-10 shadow-md'>
      <div className='flex justify-start'>
        <Link href='/' className='duration-200 hover:scale-110'>
          <h1 className='text-3xl font-bold text-red-500'>KNU CREW</h1>
        </Link>
      </div>
